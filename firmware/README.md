...
|---|---:|---:|
| Current: the 2026-09-15 review fixes combined (PIN, Host check, OTA board check, WPA2 setup AP + QR, transport completeness, transit-first polling, per-stop health on the panels, checked SD writes, log export) | 1,822,930 B (95.9 %) | 95,644 B (29.2 %) |
