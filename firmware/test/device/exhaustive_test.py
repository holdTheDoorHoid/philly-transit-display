...
roundtrip('ticker alerts only', lambda c: (c.update(alerts=True), c['device'].update(ticker_show='alerts')), lambda g: g['device']['ticker_show'] == 'alerts' and 'detour' not in ui().get('ticker', 'detour') and ui().get('ticker') != '')
roundtrip('ticker detours only', lambda c: (c.update(alerts=True), c['device'].update(ticker_show='detours')), lambda g: g['device']['ticker_show'] == 'detours' and 'detour' in ui().get('ticker', '') and 'New Bus Network' not in ui().get('ticker', ''))
roundtrip('ticker both', lambda c: (c.update(alerts=True), c['device'].update(ticker_show='both')), lambda g: 'detour' in ui().get('ticker', '') and ': ' in ui().get('ticker', ''))
